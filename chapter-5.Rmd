...
Each summary of grouped variables peels one layer off of the grouping, making it simple to roll up a dataset. You have to be careful here though, since groupwise and overall statistics are not always the same.
...
dest_count <- group_by(not_canceled, dest)
summarise(dest_count, n())
  
# not_canceled %>% count(tailnum, wt = distance)
by_plane <- group_by(not_canceled, tailnum)
